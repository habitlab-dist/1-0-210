(function(){
  ...
  polymer_ext({
    ...
    openBy: async function(evt){
      var dialog_intervention, dialog_goal, enabled_interventions;
    ...
    */,
    ...
    methods: ['SM', 'S', 'once_available', 'first_elem']
  });
}).call(this);
